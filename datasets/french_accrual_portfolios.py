...
RAW_FILE_PATH = DATA_DIR + "/french_accrual_portfolios_raw.csv"
CLEAN_FILE_PATH = DATA_DIR + "/french_accrual_portfolios_clean.parquet"


class AccrualPortfolios(Dataset):
