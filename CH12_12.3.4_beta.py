...
# Generate plot
sns.lineplot(df, x="date", y="alpha_1", label="Low Beta", color="k", linestyle="dashed")
sns.lineplot(df, x="date", y="alpha_10", label="High Beta", color="k")
plt.axhline(0, color="k", linestyle="dotted")
plt.ylabel("Alpha (bps)")
plt.xlabel(None)
plt.savefig("plots/CH12_12.3.4_beta.png", dpi=300)
